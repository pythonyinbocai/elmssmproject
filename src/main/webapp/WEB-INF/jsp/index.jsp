...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath }/framework/icon.css" rel="stylesheet">
	...
	<body>
		...
		<div class="wrapper">
			...
			<!-- 点餐分类部分 -->
			<ul class="foodtype">
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=1'">
					<img src="img/dcfl01.png">
					<p>美食</p>
				</li>
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=2'">
					<img src="img/dcfl02.png">
					<p>早餐</p>
				</li>
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=3'">
					<img src="img/dcfl03.png">
					<p>跑腿代购</p>
				</li>
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=4'">
					<img src="img/dcfl04.png">
					<p>汉堡披萨</p>
				</li>
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=5'">
					<img src="img/dcfl05.png">
					<p>甜品饮品</p>
				</li>
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=6'">
					<img src="img/dcfl06.png">
					<p>速食简餐</p>
				</li>
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=7'">
					<img src="img/dcfl07.png">
					<p>地方小吃</p>
				</li>
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=8'">
					<img src="img/dcfl08.png">
					<p>米粉面馆</p>
				</li>
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=9'">
					<img src="img/dcfl09.png">
					<p>包子粥铺</p>
				</li>
				<li onclick="location.href='${pageContext.request.contextPath }/business/listBusinessByOrderTypeId?orderTypeId=10'">
